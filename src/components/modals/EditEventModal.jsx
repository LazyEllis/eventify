...
const EditEventModal = ({ isOpen, onClose, eventId, event, onSuccess }) => {
  const [error, setError] = useState("");

  // Initialize form data directly from the event prop
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedEvent = await api.updateEvent(eventId, event);
